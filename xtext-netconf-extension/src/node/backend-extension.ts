...
export default new ContainerModule(bind => {
    bind<LanguageServerContribution>(LanguageServerContribution).to(NETCONFContribution);
});
...
@injectable()
class NETCONFContribution extends BaseLanguageServerContribution {
    ...
    protected onDidFailSpawnProcess(error: Error): void {
        ...
        console.error("Error starting NETCONF language server.", error)
    }
